...
const FAQS: QA[] = [
  ...
  },
  {
    ...
    a: "Every feature is unlocked on the free plan \u2014 nothing is crippled. The only limit is 50 actions per month (likes, replies, follows and the rest combined), which resets each month. Pro removes the cap for $12.99/month (or $3.99/week), and you can cancel any time in one click.",
  },
  {
