    ...
    (async () => {
      try {
        ...
        const json = (await res.json()) as
          | { ok: true; data: { token: string; user: User; nonce?: string | null } }
        ...
        // The nonce was generated by the extension at sign-in start and round-tripped
        // through the backend. The content script rejects the message if the nonce
        // doesn't match what the extension stored.
        window.postMessage(
          {
