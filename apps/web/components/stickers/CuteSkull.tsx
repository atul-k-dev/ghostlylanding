...
export function CuteSkull({ className, rotate = -4 }: Props) {
  return (
    ...
    >
      ...
      {/* Eye highlights */}
      <circle cx="46" cy="58" r="2.5" fill="#B81336" />
      <circle cx="82" cy="58" r="2.5" fill="#B81336" />
      {/* Nose */}
      <path
      ...
      />
      {/* Cheek dots */}
      <circle cx="28" cy="82" r="3" fill="#B81336" opacity="0.65" />
      <circle cx="92" cy="82" r="3" fill="#B81336" opacity="0.65" />
