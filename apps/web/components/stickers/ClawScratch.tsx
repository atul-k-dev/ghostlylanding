...
export function ClawScratch({ className, rotate = -6 }: Props) {
  return (
    ...
    >
      ...
      {/* Drips */}
      <path d="M 40 28 Q 40 44 42 52" stroke="#b91c1c" strokeWidth="3" fill="none" strokeLinecap="round" />
      <path d="M 90 58 Q 92 76 88 88" stroke="#b91c1c" strokeWidth="3" fill="none" strokeLinecap="round" />
      <path d="M 130 88 Q 132 102 130 110" stroke="#b91c1c" strokeWidth="3" fill="none" strokeLinecap="round" />
      <path d="M 60 88 Q 58 100 62 108" stroke="#b91c1c" strokeWidth="2.5" fill="none" strokeLinecap="round" />
    </svg>
  );
}
