...
> **Status:** Phase 0 in progress (0.1, 0.2, 0.6 done · 2.5 spike awaiting Chrome verification)
...
- [ ] **0.3 — Flip the unknown-age default to conservative.**
      Fixes **D3**.
